...
class Reader extends EventEmitter {
     ...
     * @param {{ (id: string, state: string | number | boolean | ioBroker.State | Partial<ioBroker.State>, ack?: boolean | undefined): Promise<string>; }} setStateAsync
     * @param {ioBroker.Logger} log
     */
    constructor(creator, setStateAsync, log) {
        super();

        this.creator = creator;
        this.setStateAsync = setStateAsync;
        this.log = log;
